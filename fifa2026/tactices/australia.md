...
## Identity & Philosophy
Tony Popovic's Australia is **organized, hard-running and counter-attacking** — the modern Socceroos identity refined into something braver than expected. After a 2-0 statement win over Türkiye in their World Cup 2026 opener, Popovic doubled down on a **back-three 3-4-2-1** built on **structural discipline, aerial dominance and lethal transitions** through the wide channels, with two roaming #10s feeding off a pacy lone striker. Australia does not chase possession against good opposition; the Türkiye plan — sit in a mid-block, absorb, then spring Irankunda and Touré into space — was a counter-attacking masterclass. The squad is **fitness-obsessed** (every outfielder 14+ stamina) and astonishingly young: Popovic's opener featured **ten World Cup debutants**, including the surprise of the tournament — 22-year-old Melbourne City keeper **Patrick Beach**, who made eight saves and kept a clean sheet, picked ahead of veteran captain Mat Ryan. Vice-captain Jackson Irvine was also benched in favour of 21-year-old Paul Okon-Engstler. The young spine of Beach, Circati, Bos, Okon-Engstler, Irankunda and Touré around veterans Souttar and Burgess delivered three points on Matchday 1; Australia sits level with the USA on three points ahead of their June 19 clash in Seattle.
...
- Role mapping (roster order in `australia.yaml`):
  ...
  - index 8: LAM — **Connor Metcalfe** (#8) — left-sided #10 / shuttler, the disciplined runner who arrives late and strikes from distance (scored from 23m vs Türkiye); links the midfield to the front line.
  - index 9: RAM — **Nestory Irankunda** (#17) — the teenage flyer (speed 17, dribbling 16) as the right-sided #10, direct on the dribble, cuts inside off the right, opened the scoring vs Türkiye; the chief open-play creative spark.
...
(Note: the back three reads Burgess–Souttar–Circati left to right with Bos/Italiano as the wing-backs, the double pivot reads O'Neill–Okon-Engstler, and Metcalfe & Irankunda are the two #10s behind Touré; the engine should treat the wing-backs as the team's only true width.)

## Style of Play

### Build-up
Pragmatic and direct. Australia builds from the back three when uncontested but goes long the moment a press arrives. Beach is brave but defaults to a goal-kick aimed at Souttar or the channels. Circati starts the progression from the right of the three, while O'Neill drops between the lines to receive and recycle and Okon-Engstler looks to break a line with a forward ball. The first long ball is typically aimed at Touré running the channel; the second feeds Irankunda's feet wide right and lets him carry. Australia is content to play 40% possession against superior opposition and live in transition.
