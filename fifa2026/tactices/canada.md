...
**Round of 32 (28 June, vs South Africa — SoFi Stadium, Los Angeles):** Canada are into the knockout stage for the **first time in their history** — but as runners-up, not group winners. After a historic group (a first-ever World Cup point vs Bosnia, then a thumping **6-0 win over Qatar** with a Jonathan David hat-trick), a **1-2 loss to Switzerland** in the decider cost them top spot — and with it home advantage. Instead of BC Place in Vancouver, Marsch's side travel to Los Angeles, the first World Cup co-host to play a knockout game outside its own borders ("we needed a draw to stay home"). Two personnel stories carry over. **Ismaël Koné is OUT for the tournament** (broken leg vs Qatar); **Nathan Saliba** — a scorer in that win — keeps the central-midfield berth. **Alphonso Davies** is finally fit and available for his first appearance of the tournament after a hamstring strain, but is expected to **start on the bench** and be unleashed as a game-changing substitute rather than thrown in cold; **Richie Laryea continues at LB**. Yellow cards reset for the knockouts, clearing Cornelius. Marsch keeps the **4-4-2** that hammered Qatar.
...
## Tournament Mindset
Canada under Marsch is the **most physically aggressive** team in the tournament. The press, the sprint duels, the tactical fouling — it is a Red Bull team in a Canada shirt. The group stage delivered historic firsts (first point, first win, first knockout berth) but the Switzerland loss carries a sting: no home crowd in the last 32, a long trip to Los Angeles instead of Vancouver. The chief worries are the **thinner-than-ideal midfield** after Koné's tournament-ending injury (Saliba holds the central screen) and **stamina management** — Marsch's press demands 90-minute intensity, and a knockout can run to 120. The carrot is **Alphonso Davies**, fit at last and waiting on the bench to weaponize the left in the final half-hour. Expect Canada to press South Africa's build-up, score in transition through David and Larin, and back themselves to win a one-off knockout against a Bafana side making its own history.
