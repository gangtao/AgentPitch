...
- Role mapping (roster order in `curacao.yaml`):
  - index 0: GK — **Eloy Room** (1) — veteran shot-stopper, MLS/Eredivisie-tested; not a sweeper, stays on the goal line. The hero of the Ecuador draw with a record-equalling 15-save shutout.
...
9. **Score-state management (vs Ivory Coast, must-win):** If **leading**, drop the block deeper after minute 70 (5-4-1 with CM "_6" — Juninho Bacuna — dropping between the CBs) and burn the clock. If **drawing or trailing** (a draw is not enough to advance), do **not** sit back: push the fullbacks ("_1" Floranus, "_4" Fonville) higher, commit Comenencia "_7" and Chong "_8" forward, and gamble on chasing the goal — a draw sends Curaçao out.
...
## Tournament Mindset
Curaçao came to the World Cup to **be there** — and after the chastening 7-1 opening loss to Germany, the historic 0-0 with Ecuador (their first-ever point, Room's 15-save masterclass) turned the campaign into something more. Now comes the **win-or-bust final group game vs Côte d'Ivoire** at Lincoln Financial Field, Philadelphia (Thu June 25). The maths are brutal: Curaçao sit **bottom of Group E** on 1 point and **must win** — and hope results elsewhere fall their way — to have any chance of the last 32, while a draw or defeat sends them home. Ivory Coast, on 3 points, need only avoid defeat to seal second thanks to their head-to-head edge over Ecuador, so they may sit deep too. That changes the equation: for the first time Curaçao may have to **chase the game** rather than purely absorb. Expect the deep block early, but a willingness to commit Comenencia and the fullbacks forward and gamble on set pieces and Chong/Hansen transitions if the score demands it. The squad has no Premier League stars and no Champions League regulars, but has Eredivisie depth, the Opta supercomputer's disrespect (Ivory Coast favoured in 82% of simulations), and the diaspora's chip-on-shoulder mentality. Advocaat's tactical clarity and emotional management is the team's biggest asset. A win would be the greatest day in the smallest World Cup nation's history.
