...
- Role mapping (roster order in `haiti.yaml`):
  ...
  - index 1: LB — **Duke Lacroix** (#13) — disciplined left-back (Colorado Springs Switchbacks); comes in for Expérience for the final group game, the more conservative fullback who prioritizes defensive solidity over the overlap.
...
### Defensive shape
**Compact 4-4-2** out of possession with Deedson and Providence tucking into a flat midfield four. Bellegarde and Jean Jacques shield the back four; one striker drops onto the opposing pivot while the other stays high. The block is **mid-to-low** — Haiti is happy to absorb pressure in its own third and counter (as it did for long stretches against Scotland, and as it tried before being overrun by Brazil). The CBs hold a moderate line, not high; the offside trap is not a weapon. Against Morocco — quick, technical, and chasing top spot — expect this block to sit deep again and live off transitions, with nothing left to lose and pride to play for.
...
10. **If team is drawing or losing and minute > 75:** Push LB "_1" (Lacroix) forward, drop to 3-4-3 risk-on; otherwise keep the 4-4-2 block.
...
## Tournament Mindset
Haiti is at the World Cup as a national catharsis after a brutal half-decade of political crisis. The dream is over on results — a **0-1 loss to Scotland** followed by a chastening **0-3 to Brazil** has **eliminated** the Grenadiers, who are mathematically locked into fourth place whatever happens against Morocco. But the **final group game** is its own kind of occasion: a first World Cup in 52 years deserves a parting performance, and there is freedom in having nothing to lose. The plan against **Morocco** is the same one that has defined the campaign — a low-to-mid block, soak the pressure, and live for the 2-3 lightning counter-attacks where the squad's physical profile (speed 14-15 from the wide midfielders and Isidor) is genuinely dangerous. Migné will rotate at the margins (Lacroix in at left-back) but trust the established spine. The realistic objective is pride: a clean sheet protected as long as possible, a goal to take home, and a result that lets a battered nation walk away from the tournament with its head high. Bellegarde remains the difference-maker; if he is on the pitch and on form, Haiti has a puncher's chance on the break against even a quality Morocco side.
