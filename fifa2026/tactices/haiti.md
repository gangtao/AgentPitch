...
- Role mapping (roster order in `haiti.yaml`):
  ...
  - index 1: LCB — **Ricardo Adé** (#4) — physical, aerially dominant CB; the box-defender on crosses.
  - index 2: RB — **Carlens Arcus** (#2) — disciplined RB; rarely overlaps, prioritizes defensive solidity.
  - index 3: RCB — **Hannes Delcroix** (#5) — ball-playing CB; comfortable on the ball, the progressor from the back.
  - index 4: LB — **Duke Lacroix** (#13) — modest attacking LB; the more adventurous of the two fullbacks but still disciplined.
  - index 5: DM/6 — **Carl Sainté** (#6) — disciplined holding midfielder; the line-protector in front of the back four.
  - index 6: CM — **Jean-Ricner Bellegarde** (#10) — the team's most-decorated player (Premier League with Wolves). The chief creator from midfield; gets between the lines, drives forward with the ball.
  - index 7: CM — **Danley Jean Jacques** (#17) — physical box-to-box, the runner who supports Bellegarde and tracks back.
  - index 8: LW — **Louicius Deedson** (#11) — pacy wide forward (FC Dallas); cuts inside off the left, the team's transition outlet.
  - index 9: CF — **Wilson Isidor** (#18) — physical, fast striker (Sunderland); the team's chief finisher and shot rating leader. Runs the channels.
  - index 10: RW — **Derrick Etienne Jr.** (#7) — MLS-experienced wide forward (Toronto FC); cuts inside or stays wide, secondary creator.

## Style of Play

### Build-up
**Direct.** Haiti does not try to play out from the back against a press. Placide often goes long from goal kicks aiming at Isidor for a knock-down or into the channels for Deedson / Etienne. When building short (against weaker opposition or in safe phases), Sainté drops between the CBs, Delcroix carries forward as the progressor. Bellegarde is the link between defense and attack — receive on the half-turn, drive forward.
...
### Defensive shape
**Compact 4-5-1** out of possession with Deedson and Etienne dropping into a midfield five. Bellegarde sits between the lines, Sainté and Jean Jacques shield the back four. The block is **mid-to-low** — Haiti is happy to absorb pressure in its own third and counter. The CBs hold a moderate line, not high; the offside trap is not a weapon.
...
## Set Pieces
- Attacking corners: **Bellegarde** delivers from the right (in-swinger), **Duke Lacroix** from the left (in-swinger). Primary aerial targets: Adé (penalty spot), Isidor (near post), Hannes Delcroix (back post).
...
1. **If my player_id ends with "_6" (CM, jersey #10 — Bellegarde) and I receive the ball facing forward in midfield:** Carry forward (skill 15, dribbling 14). Through-ball to CF "_9" (Isidor) or LW "_8" (Deedson) is the priority.
...
5. **If my player_id ends with "_9" (CF, jersey #18 — Isidor) and a long ball is in flight:** Hold position, contest the aerial duel, lay off to CM "_6" (Bellegarde) or LW "_8" (Deedson).
...
10. **If team is drawing or losing and minute > 75:** Push LB "_4" (Duke Lacroix) forward, drop to 3-4-3 risk-on; otherwise keep the 4-5-1.
11. **If my player_id ends with "_1" (LCB, jersey #4 — Adé) and a cross is incoming:** attack the first ball at the penalty spot. Do not get drawn to the near post.
...
- **Isidor (#18):** Primary finisher and penalty taker. Shoot rating 15 — the team's most clinical attacker.
- **Deedson (#11):** Pacy LW (FC Dallas). The transition outlet on the left.
- **Adé (#4):** Aerially dominant CB. The box-defender on set pieces both ways.
- **Etienne (#7):** MLS-experienced RW (Toronto FC). Secondary creator.
- **Sainté (#6):** Disciplined holding midfielder. Frees Bellegarde to push forward.
