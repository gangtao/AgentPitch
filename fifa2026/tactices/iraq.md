...
- Role mapping (roster order in `iraq.yaml`):
  ...
  - index 1: LB — **Hussein Ali** (Pogoń Szczecin) — disciplined fullback, defensive-first, rarely overlaps deep.
