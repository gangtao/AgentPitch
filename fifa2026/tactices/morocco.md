...
## Identity & Philosophy
Mohamed Ouahbi's Morocco — who took over from Walid Regragui in March 2026 — carries forward the counter-attacking ferocity that powered the 2022 World Cup semi-final run, now built around a younger, more technical spine. They defend in a compact mid-block, then break vertically through Hakimi's overlap and the on-ball quality of Brahim Díaz, El Khannouss and Ounahi. The Atlas Lions came through Group C unbeaten, then knocked out Ronald Koeman's Netherlands **on penalties** in the Round of 32 (June 29, Estadio BBVA, Monterrey) — Bounou the shootout hero with an innovative save, extending Morocco's status as the ultimate tournament specialists (three of their last knockout wins have come via spot-kicks). They remain **unbeaten across the whole tournament** and have tightened with every game: through the knockouts they have faced just ~8.3 shots and ~0.8 xGA per match — the meanest defensive record of any edition. For this round Ouahbi keeps faith with his strongest XI and the squad is a clean bill of health: no injuries, no suspensions carried in. They are tournament-tested: disciplined, fearless, and ruthless on the transition. Next up is Canada in the Round of 16 (July 4, Houston) — co-hosts riding a fairy-tale run to their first-ever last-16, but 24 places below Morocco in the FIFA ranking. The Atlas Lions are the clear favourites: frustrate Canada's front-foot energy, then strike on the break.
...
14. Knockout vs Canada (Round of 16) — this is single-elimination, so there is no goal-difference incentive: a 1-0 is as good as a 4-0. Morocco are the favourites here, but Canada are a front-foot, high-energy co-host side (Alphonso Davies down the left, Jonathan David and Oluwaseyi up top, David Buchanan/Buchanan-Millar width) who press and counter — so the discipline stays. Do not over-commit numbers forward and gift Canada the transition, especially the left flank where Davies attacks the `_4` (Hakimi) side. Control tempo, make them chase, and strike on one Hakimi-`_4`-fed counter, a Brahim `_9` moment, or a set piece. Bank the lead and defend it in the mid-block. Entirely comfortable taking the tie to extra time / penalties (Brahim `_9` first, Hakimi `_4` second, Rahimi third) — Bounou `_0` is a shootout weapon.
...
## Tournament Mindset
Patient and ruthless on the transition; Morocco believes any match can be won 1-0 on a Hakimi assist and a Bounou clean sheet. Having come through Group C unbeaten and then eliminated Koeman's Netherlands on penalties in the Round of 32 — Bounou the shootout hero — the Atlas Lions arrive at the last 16 as the meanest defence of the tournament (~0.8 xGA per game) and, this time, the clear favourites. The opponent is **Canada**, the co-hosts, riding a fairy-tale first-ever run to the Round of 16 on a dramatic late win over South Africa. They are 24 places below Morocco in the FIFA ranking but dangerous on emotion and transition: Alphonso Davies raiding from the left, Jonathan David and Oluwaseyi in behind, a home crowd in Houston behind them. This is knockout football: no goal-difference incentive, so the plan is to stay compact, deny Canada clean transitions (mind the Davies-vs-Hakimi flank), and strike through Hakimi, Brahim and Saibari or from a set piece. They are entirely comfortable taking the tie deep — to extra time and penalties — where their nerve and Bounou's shot-stopping make them lethal (Brahim first, Hakimi second, Rahimi third). The mindset is fearless control: respect the opponent, suffer when needed, avoid needless bookings over a long knockout run, and trust one moment of Brahim or Hakimi quality to settle it.
