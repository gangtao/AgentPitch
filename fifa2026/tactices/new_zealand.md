...
- Role mapping (roster order in `new_zealand.yaml`):
  ...
  - index 8: LW — **Elijah Just** (Motherwell) — the team's fastest player (speed 15), direct runner, gets in behind, the main outlet in transition. Scored a brace on his competitive debut in the 2-2 MD1 draw vs Iran — NZ's in-form attacker.
