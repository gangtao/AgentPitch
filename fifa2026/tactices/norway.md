...
## Round of 32 Knockout (vs Ivory Coast, June 30 — AT&T Stadium, Arlington TX)
Win or go home. With the France dead rubber behind them, Solbakken restores his first-choice spine: Nyland returns in goal (Selvik deputised vs France), Haaland and Ødegaard are back from the rotation, and the strongest XI takes the field. The one genuine doubt is RB Julian Ryerson, who missed the France game with a thigh problem; Solbakken reports him "improving day-by-day" and he is expected to start — if he fails a late fitness test, Aursnes drops to right-back and Patrick Berg enters midfield. Ivory Coast are a quick, physical, transition-oriented African side, so the same warning from the Senegal game applies: the back four cannot step up loosely, and the wide forwards must recover. This is a one-off knockout — no second leg, no points to manage. Norway will back themselves to win a shootout because of Haaland, but cannot afford the defensive sloppiness that nearly cost them against Senegal.
...
## Tournament Mindset
Norway are dangerous in any moment but vulnerable to teams that exploit central midfield gaps when Aursnes pushes forward. They will trade chances; in a high-scoring shootout they back themselves to outscore anyone because of Haaland — and now carry a second aerial threat in Sørloth. This is the knockouts: a single-leg Round of 32 against Ivory Coast with everything on the line, so the calculus is simply to win. Solbakken sends out his strongest XI and goes for it — but the lesson of the Senegal scare and the France rotation defeat is that defensive discipline wins knockouts. Expect Norway to attack through Haaland and Ødegaard while keeping Berge anchored, the wide forwards honest in recovery against Ivory Coast's pace, and a readiness to take the tie to extra time and penalties — where Haaland from the spot is as good a card as anyone holds.
