...
- Role mapping (roster order in `paraguay.yaml`):
  - index 0: GK — **Gatito Fernández** — traditional shot-stopper, stays in the box, modest with feet.
  ...
  - index 6: DM/RCM — **Damián Bobadilla** — box-to-box partner, slightly more progressive than Cubas, the legs of the pivot (replaces Villasanti).
...
## Style of Play
### Build-up
**Direct.** Paraguay does NOT play short for the sake of it. Gatito Fernández often goes long toward Sanabria. When playing short, Alderete and Gustavo Gómez go to the CBs, but the ball doesn't linger — Cubas receives and looks vertical. Long diagonals to Almirón on the right are a primary release valve. Paraguay is happy to be **30% possession** and route 1.
...
2. **If my `role == "GK"` (player_id `_0`, Gatito Fernández) and pressed by any opponent:** Punt long toward `_9` (Sanabria) — do NOT play short under pressure.
