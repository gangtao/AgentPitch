...
- Role mapping (roster order in `saudi_arabia.yaml`):
  ...
  - index 7: LAM — **Salem Al-Dawsari (#10)** — captain and talisman, on his third World Cup, 108 caps. Starts from the left of the band, cuts inside on his right foot. Shoot 16, dribbling 16, skill 16. The team's only world-class creator and finisher.
  - index 8: CAM — **Musab Al-Juwayr (#7)** — the technical central creator (pass 15), drifts between the lines to combine; the second creator behind Salem and a late runner into the box.
  - index 9: RAM — **Nasser Al-Dawsari (#6)** — the press-resistant right-sided attacker, drifts inside off the flank, links the pivot to the front line.
...
1. **If my player_id ends with "_7" (LAM Salem Al-Dawsari, #10) and I have the ball on the left flank:** Dribble inside onto my right foot; Shoot if distance < 23 and angle < 35°. This is the team's primary attacking pattern.
