...
- Role mapping (roster order in `saudi_arabia.yaml`):
  ...
  - index 2: LCB — **Abdulelah Al-Amri (#4)** — the aerial anchor (strength 15), the line-organiser and duel-winner, the most-capped centre-back of the pairing.
  ...
  - index 7: RAM — **Musab Al-Juwayr (#7)** — the technical right-sided creator, drifts inside to combine; the second creator behind Salem.
  - index 8: LAM — **Salem Al-Dawsari (#10)** — captain and talisman, on his third World Cup, 108 caps. Starts from the left of the band, cuts inside on his right foot. Shoot 16, dribbling 16, skill 16. The team's only world-class creator and finisher.
  - index 9: CAM — **Nasser Al-Dawsari (#6)** — the press-resistant central attacking midfielder, late runner into the box, links the pivot to the front three.
  - index 10: CF — **Firas Al-Buraikan (#9)** — the lone 9, hold-up player, the press-leader, the channel-runner, the team's leading striker (15 international goals).

## Style of Play

### Build-up
Direct and pragmatic. Saudi Arabia builds short from the back when uncontested but immediately goes long when pressed. The chief progressor is Al-Tambakti — he steps into midfield with the ball and fires diagonals. The team's preferred build-up is short-short-LONG: Al-Owais to Al-Tambakti, Al-Tambakti to Kanno, Kanno to a long diagonal toward Salem isolated on the left flank. Possession is not a goal — verticality is. The first thought is always **find Salem 1v1 on the left**.
...
### Defensive shape
Compact **4-4-1-1** with Salem dropping to LM out of possession (yes — Salem tracks back, a Donis non-negotiable). Al-Juwayr drops to RM. Nasser Al-Dawsari plays just behind Al-Buraikan in transition but drops into the midfield five when defending. The back four sits 25 units off goal. The CBs (Al-Amri, Al-Tambakti) hold the line. The shape is famously hard to break down — Saudi Arabia conceded only 4 goals in the 2022 group stage despite drawing Argentina and Mexico.

### Wide play
**Asymmetric, heavily left-loaded.** Almost every Saudi attack runs through Salem on the left. He cuts inside on his right foot, Boushal underlaps to occupy the opposition RB, and Nasser Al-Dawsari arrives late from central midfield. The right side is the secondary outlet — Al-Juwayr drifts inside, Abdulhamid overlaps. The crosses come from deep when they come at all; Saudi Arabia would rather have Salem cut inside and shoot than cross from the touchline.
...
## Set Pieces
- Attacking corners: **Salem Al-Dawsari** in-swingers from the right (right foot), **Nasser Al-Dawsari** out-swingers from the left. Targets: Al-Amri (penalty spot, primary aerial), Al-Tambakti (back post), Al-Buraikan (near post flick-on).
...
2. **If my player_id ends with "_8" (LW Salem, #10) and team_phase == "defending":** Drop to LM. Donis's instruction is non-negotiable — Salem tracks back.
...
5. **If my player_id ends with "_2" (LCB Al-Amri, #4) and a cross or aerial duel is incoming:** Attack the ball aggressively. Win the header. Strength 15, aerial anchor.
6. **If team_phase == "transition_attack":** Index-8 Salem (LW) sprints diagonally inside; index-10 Al-Buraikan runs the channel; index-9 Nasser Al-Dawsari is the trailer; index-7 Al-Juwayr the secondary runner on the right.
...
## Key Player Notes
- **Salem Al-Dawsari (index 8, #10):** The team. The captain and talisman. The scorer of the goal that beat Argentina. Cuts inside from the left, shoots, takes every set-piece. 108 caps, third World Cup. Without him, Saudi Arabia is mid-table Asian. With him, they're a knockout-stage threat.
- **Al-Amri (index 2, #4):** The aerial anchor and line-organiser. Strength 15. Wins the set-piece duels in both boxes.
...
- **Al-Juwayr (index 7, #7):** The young technical creator. The second source of invention behind Salem.

## Tournament Mindset
Saudi Arabia carries the swagger of Argentina-22 — they know they can beat anyone on any day. The mentality is **organize, defend, wait for Salem's moment**. They will lose 2-0 to a top-eight side they didn't get an opening against, then beat the next opponent 1-0 on a Salem free kick. The hidden weapon is **mental resilience** — they don't panic when behind, and they execute the tactical plan to the letter for 90 minutes. The vulnerability is creativity if Salem is well-marked or absent — the secondary creators (Al-Juwayr, Nasser Al-Dawsari) are good but not match-winning. Set-piece coaching is a priority under Donis and the team practices dead-balls for hours every week. A further question mark is continuity: Donis arrived only weeks before the finals, so the side leans on its ingrained 2022 identity rather than a new tactical layer.
