...
- Role mapping (roster order in `south_korea.yaml`):
  ...
  - index 1: LB — **Lee Tae-seok** — energetic overlapping fullback, the natural width-giver on the left because Son cuts inside; hard-running, gets up and down the touchline.
  ...
  - index 4: RB — **Seol Young-woo** — quick, attacking fullback; provides the overlap on the right when Lee Jae-sung drifts inside, the highest-stamina defender.
  ...
  - index 8: CAM/10 — **Lee Kang-in** — the creative spark, the central #10, drifts to the right half-space to combine with Son cutting inside from the left. PSG-trained, technical, set-piece taker.
  - index 9: RAM/RW — **Lee Jae-sung** — Mainz workhorse, the box-to-box engine on the right of the three, late runner into the box from deep, the team's stamina monster.
...
### Pressing
**High-intensity, leader-driven, but selective** — South Korea presses on triggers (back-pass to GK, heavy first touch, throw-in in own half) rather than every possession. Oh leads the press from the front, with Lee Jae-sung and Son curving in from the wide attacking positions. Paik Seung-ho is the midfield jumper — he sprints 15 yards to engage the opposition pivot. Son does NOT press for 90 minutes; he is rationed for transitions. The team's stamina ratings (the spine all 15+) make this sustainable across a World Cup match.

### Defensive shape
Drops into a compact **4-4-1-1** with Paik Seung-ho and Hwang In-beom as the central screen, Son and Lee Jae-sung tucking back as the wide midfielders in a flat four, and Lee Kang-in floating just ahead as the link. Oh Hyeon-gyu stays high as the lone press target. Kim Min-jae is licensed to step up aggressively — he wins his duels because he is the strongest player on the pitch (strength 18).

### Wide play
**Asymmetric.** Left side: Son cuts inside from the touchline into the right half-space, Lee Tae-seok overlaps as the natural width-giver. Right side: Lee Jae-sung drifts inside to combine, with Seol Young-woo providing the overlap. Both flanks funnel attacks centrally — South Korea is NOT a crossing team. They want shots from inside the 18-yard box.

### Final third
The chief patterns: Son's cut-inside curler from the left half-space (right foot), Lee Kang-in's slipped through-ball to Son sprinting in behind, Oh's near-post header from a Lee Tae-seok cross, Lee Jae-sung's late arrival into the box from the right. South Korea is a counter-attack monster — Son's 18 speed means three passes and a finish in under 10 seconds.
...
1. **If my player_id ends with "_7" (LAM/LW Son Heung-min, #7) and I have the ball on the left flank:** Dribble diagonally inside toward the right half-space; Shoot if distance < 25 and angle is open. Otherwise Pass to the index-10 Oh's near-post run or the index-9 Lee Jae-sung's late run.
...
4. **If my player_id ends with "_8" (CAM Lee Kang-in, #19) and I have the ball between the lines:** Look first for the index-7 Son's run in behind on the left; second, dribble forward; third, Shoot if distance < 20.
...
7. **If my player_id ends with "_6" (DM Hwang In-beom, #6) and I have the ball:** Look first for a forward diagonal to the index-7 Son (left) or the index-9 Lee Jae-sung (right). Avoid sideways passes — South Korea plays vertically. The index-5 Paik Seung-ho stays as the holding partner behind me.
8. **If my player_id ends with "_10" (CF Oh Hyeon-gyu, #18) and the ball is in the opposition box:** Position at the near post for a header from the index-1 Lee Tae-seok's cross.
9. **If my player_id ends with "_9" (RAM Lee Jae-sung, #10) and the index-8 Lee Kang-in has the ball:** Make a late forward run from deep — I am the box-arrival threat from the right.
10. **If team is trailing in the final 20 minutes:** Push the index-4 Seol Young-woo and index-1 Lee Tae-seok high as wingbacks; the index-9 Lee Jae-sung and index-7 Son both go high; the index-8 Lee Kang-in becomes the lone 10 behind a front three.
...
12. **Set-pieces inside 30 units of goal:** Defer to the index-7 Son (left half-space) or the index-8 Lee Kang-in (right half-space).
...
- **Lee Kang-in (index 8):** The creator and central #10. Drifts to the right half-space, takes set-pieces, slips through-balls. The other technical superstar after Son.
