...
### Defensive shape
4-5-1 / 4-1-4-1 in defense. Bergvall drops to a left-of-center midfield position to compensate for Elanga's high starting point. Svanberg shields the back four; Ayari mirrors on the right when needed. Hien dominates aerially; Lindelöf reads the game.

### Wide play
Elanga's speed (18) on the left is Sweden's primary outlet. Gudmundsson overlaps. On the right, Gyökeres drifts wide to combine with Svensson, then attacks centrally on cutbacks.
...
4. If my player_id ends with "_0" (GK, Johansson): if Sweden regains the ball or wins a goal kick under heavy press, kick LONG toward "_10" (Gyökeres) or down the "_8" (Elanga) channel.
5. If my player_id ends with "_7" (CM/#10, Bergvall): always demand the ball facing forward; if a vertical lane to "_9" (Isak) / "_10" (Gyökeres) exists, PASS within 1 tick. Otherwise carry the ball forward through the left-center.
...
8. If my player_id ends with "_1" (LB, Gudmundsson): overlap when "_8" (Elanga) cuts inside; primary left-side crosser.
