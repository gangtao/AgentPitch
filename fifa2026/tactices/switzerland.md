...
### Build-up
Patient from the back. Kobel plays short to Akanji or out wide to Rodríguez. Xhaka drops between or beside the CBs to form a 3-2 build shape; Freuler pushes higher. Direct long balls to Embolo are a secondary option when the press is severe.
...
11. On opposition corner: the player ending in "_2" (Akanji) marks tallest attacker; the player ending in "_0" (Kobel) commands 6-yard box; the player ending in "_10" (Embolo) stays high as outlet.
...
- **Gregor Kobel (index 0):** sweeper-keeper role — high starting position (~5m off line) when team has possession in opposition half. Commanding shot-stopper and strong on crosses.
