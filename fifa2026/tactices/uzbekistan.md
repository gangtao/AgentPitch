...
## Identity & Philosophy
Uzbekistan, coached by **Fabio Cannavaro** (appointed October 2025, after Timur Kapadze led them through qualification and stayed on his staff), are **first-time World Cup qualifiers** and the most physically modern Asian side outside Japan. The identity is **athletic, organized, pragmatic counter-attacking football** built around two genuine European-quality players — **Abdukodir Khusanov** (Manchester City CB) and **Abbosbek Fayzullaev** (İstanbul Başakşehir attacking midfielder) — supported by captain and record scorer **Eldor Shomurodov** (also at Başakşehir, on loan from Roma). Cannavaro has sharpened the side's defensive discipline: sit deep, stay compact, spring Shomurodov and Fayzullaev on the counter. Uzbekistan's tactical model is closest to a **mid-table Eredivisie or Russian Premier League** side: compact mid-block, vertical counter-attacks, set-piece danger, and growing belief from a decade of producing genuine European-level prospects. Recent form: ended a 16-attempt drought to reach a World Cup, qualifying from their AFC third-round group.

**Matchday 1 (17 June, vs Colombia — lost 1-3, Estadio Azteca):** A spirited debut. Cannavaro set up in his usual risk-averse **3-4-2-1**: Yusupov; Khusanov, Ashurmatov, Abdullaev; **Karimov** (right wing-back), Shukurov, Mozgovoy, Nasrullaev; Fayzullaev, Urunov, Shomurodov. Daniel Muñoz volleyed Colombia ahead on 40'; **Fayzullaev headed the equaliser on 60'** before Luis Díaz restored the lead five minutes later (a low shot **goalkeeper Utkir Yusupov should have kept out** — the night's one clear keeper error), and Jaminton Campaz added a 90+9' header. Khusanov picked up the team's only booking. With Karimov's prior knock flaring up after the Colombia game, Farrukh Sayfiev deputised at right wing-back for the second match.

**Matchday 2 (23 June, vs Portugal — lost 0-5, NRG Stadium, Houston):** A chastening night. The deep 5-4-1 low block held for six minutes before **Cristiano Ronaldo headed Portugal ahead (6')** and added a second on 39'; **Nuno Mendes**, an **Abduvohid Nematov own goal**, and **Rafael Leão** completed the rout. Uzbekistan never threatened — Fayzullaev was smothered between the lines and Shomurodov was starved of service. A second yellow card on the tournament tally (discipline now -2). The defeat leaves Uzbekistan bottom of Group K on **0 points** with a goal difference of **-7** (1 scored, 8 conceded).

**Matchday 3 selection (vs DR Congo, 27 June, Mercedes-Benz Stadium, Atlanta):** A dead-rubber-for-qualification but pride-and-history finale: both sides are eliminated from automatic progression, but Uzbekistan are desperate to avoid finishing their first-ever World Cup pointless and DR Congo (3rd, 1 pt) chase a faint best-third-placed lifeline. **Behruz Karimov is fit again and returns at right wing-back**, with Sayfiev dropping to the bench. The rest of the XI is unchanged. Uzbekistan have **no injuries or suspensions** for the finale. The plan: a more front-footed version of the block against beatable opposition — DR Congo are organized but not Portugal — pressing higher, backing Fayzullaev and Shomurodov to finally convert the counters that the group's heavyweights denied them. This is the most winnable match of the three; the realistic ceiling at USA/Mexico/Canada 2026 was always escaping Group K, but the immediate goal is a maiden World Cup point — or win — to take home.
...
- Role mapping (roster order in `uzbekistan.yaml`):
  ...
  - index 7: RWB — **Behruz Karimov** (#8) — fit again after the knock that kept him out against Portugal; reclaims the right-flank slot he started in vs Colombia, holding the touchline and tucking in to cover when Khusanov steps forward.
...
(Note: Karimov is back fit for the DR Congo finale and reclaims the right-wing-back start from the deputising Sayfiev; treat Khusanov as the on-pitch leader of the defensive third whatever the trio.)
...
- Defending corners: hybrid — Khusanov attacks the first ball; Ashurmatov and Karimov mark the two most dangerous opposition runners; zonal markers fill the six-yard box; Yusupov stays on his line.
...
8. **If team_phase == "transition_attack":** Index-10 Shomurodov runs the channel; index-9 Urunov sprints diagonally; index-8 Fayzullaev is the trailer; the wing-backs (index-4 Nasrullaev, index-7 Karimov) sprint to provide the width.
...
11. **If a defensive corner is incoming:** The index-3 Khusanov attacks the first ball; the index-2 Ashurmatov and index-7 Karimov mark the two most dangerous opposition runners; the index-10 Shomurodov stays on the halfway line as a counter-outlet.
...
- **Karimov (index 7):** The first-choice right wing-back, fit again after missing the Portugal game. Functional, defensively diligent — his job vs DR Congo is to contain Yoane Wissa and Théo Bongonda's threat down that flank while overlapping Urunov in transition.
- **Shukurov (index 5):** The destroyer. Tactical fouler. The screen. Secondary set-piece deliverer.

## Tournament Mindset
Uzbekistan arrives at its first-ever World Cup with the mentality of **historic underdog with European-quality individuals**. After a spirited losing debut against **Colombia (1-3)** and a chastening **0-5** dismantling by **Portugal**, they sit bottom of Group K on **0 points** (GD -7) and are mathematically out of automatic qualification heading into the **DR Congo** finale on June 27. The motivation now is pride and history: **a maiden World Cup point — or win — to take home**, and to avoid leaving the tournament without one. DR Congo (Wissa, Bakambu, Mbemba, Wan-Bissaka) are organized and physical but a far more beatable opponent than the group's two heavyweights, so the plan shifts from pure survival to **measured aggression**: press a touch higher, back Khusanov to step the line up, and finally let **Fayzullaev and Shomurodov** convert the counters the favourites smothered. The vulnerabilities remain **stamina depth** (much of the squad is rated 13-15, on the third match in ten days) and **set-piece defending** against Mbemba's aerial threat. With Karimov fit and no suspensions, this is Uzbekistan's most winnable match: realistic outcome a tight **1-1 draw or 1-0/2-1 win**, the route to it a Fayzullaev-to-Shomurodov counter and one Khusanov set-piece header — and a first-ever World Cup victory the dream send-off.
